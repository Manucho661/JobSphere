    ...
    useEffect(() => {
        const getPostedJobs = async () => {
            try {
                ...
                if (res.data.success) {
                    setPostedJobsData(res.data.data);

                    console.log(postedJobsData);
                }
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                            <div className="stat-card bg-white rounded-lg shadow p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-gray-500 text-sm font-medium">All Jobs</p>
                                        <p className="text-3xl font-bold text-primary mt-2">{postedJobsData.total_jobs}</p>
                                        <p className="text-green-600 text-sm mt-2">{postedJobsData.this_week_jobs} this week</p>
                            ...
                            <div className="stat-card bg-white rounded-lg shadow p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-3xl font-bold text-primary mt-2">{postedJobsData.active_jobs}</p>
                                        <p className="text-green-600 text-sm mt-2">{postedJobsData.this_week_jobs} this week</p>
                            ...
                            <div className="stat-card bg-white rounded-lg shadow p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-3xl font-bold text-primary mt-2">{postedJobsData.expired_jobs}</p>
                        ...
                        <div className="bg-white rounded-lg shadow mb-6">
                            ...
                            <div className="p-6">
                                <div className="space-y-4">
                                    {postedJobsData.jobs.length > 0 ? (
                                        postedJobsData.jobs.map((job) => (
                                            <div
                                                key={job.id}
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                                <div class="bg-white rounded-lg shadow p-6">
                                    ...
                                    <div class="space-y-4">
                                        {
                                            postedJobsData.top_perfoming_jobs.length > 0 ? (<div class="flex items-center justify-between pb-3 border-b border-gray-100">
                                                <div>
