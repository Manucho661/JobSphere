              ...
              <div className="card border-0 shadow h-100">
                <div className="card-body d-flex flex-column">
                  <div className="d-flex align-items-center mb-3">
                    <FaBriefcase size={24} className="me-2 text-primary"/>
                    <h5 className="card-title mb-0">4 Job Postings</h5>
                  </div>
                  <p className="card-text">3 Active, 1 Expired</p>
                  {/* <a href="#" className="btn btn-primary mt-auto">Manage</a> */}
                </div>
              </div>
            </div>
            <div class="col-md-3">
