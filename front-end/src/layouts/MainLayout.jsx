        ...
        <main className="main min-h-screen py-2">
          ...
          <div className="px-8">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="filter-section md:col-span-2 bg-white rounded-lg p-6">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <div className="commonFilters flex gap-3">

                    {/* Job Type */}
                    <div className="relative">
                      <button
                        onClick={() => toggleDropdown('jobType')}
                        className="w-48 flex-shrink-0 whitespace-nowrap flex items-center gap-2 px-4 py-2 
                 ...
                 hover:border-yellow-300 hover:bg-gray-50"
                    ...
                    {/* Duplicate removed — keep only one Job Type */}
                 ...
                 hover:border-yellow-300 hover:bg-gray-50"
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-48 flex-shrink-0 whitespace-nowrap px-4 py-2 border border-gray-300 rounded-lg 
                 focus:outline-none hover:border-yellow-300 hover:bg-gray-50"
                      >
                 ...
                 focus:outline-none hover:border-yellow-300 hover:bg-gray-50"
                    ...
                    {/* Apply Button */}
                    <button className="w-48 flex-shrink-0 whitespace-nowrap px-4 py-2 bg-yellow-600 text-white rounded-lg text-sm font-semibold hover:bg-yellow-900">
                      <b>Apply</b>
                    </button>
